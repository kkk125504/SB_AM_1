...
public class ArticleService {
	...
	public ResultData<Integer> writeArticle(int actorId, String title, String body, int boardId, boolean secret) {
		articleRepository.writeArticle(actorId, title, body, boardId, secret);
